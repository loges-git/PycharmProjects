...
class DeploymentMonitorApp:
    ...
    def start_service(self):
        ...
        self.thread = threading.Thread(target=self.run_service_task, args=(incoming_path, base_path), daemon=True)
        self.thread.start()
    ...
    def run_service_task(self, incoming_path_str, base_path_str):
        ...
        self.add_log(f"✅ Service Started (Real-Time Watcher). {cycle_name}")
